...
import it.mds.sdk.flusso.sism.residenziale.cont.controller.FlussoSismResidenzialeContattiControllerRest;
...
class ControllerTest {
    ...
    @InjectMocks
    @Spy
    private FlussoSismResidenzialeContattiControllerRest controller;
    ...
    @Mock
    private FlussoSismResContattiService service;
    private ConfigurazioneFlussoSismResContatti.Rules rules = mock(ConfigurazioneFlussoSismResContatti.Rules.class);

    private ConfigurazioneFlussoSismResContatti.Flusso flusso = mock(ConfigurazioneFlussoSismResContatti.Flusso.class);
    ...
    private ConfigurazioneFlussoSismResContatti.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoSismResContatti.NomeFlusso.class);
