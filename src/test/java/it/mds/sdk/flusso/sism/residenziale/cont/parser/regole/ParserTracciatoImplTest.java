...
class ParserTracciatoImplTest {
    private static final String FILE_TRACCIATO_SISM_RES = "tracciato-sism-test.csv";
    ...
    void validaTracciatoOK() {
        ...
        File tracciato = new File(absolutePath + FileSystems.getDefault().getSeparator() + FILE_TRACCIATO_SISM_RES);
